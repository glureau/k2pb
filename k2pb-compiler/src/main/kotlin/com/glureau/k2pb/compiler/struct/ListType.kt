...
fun FunSpec.Builder.encodeListType(
    ...
    when (listType.repeatedType) {
        ...
        is ReferenceType -> {
            ...
            Logger.error("Nested collection detected in List encode ($fieldName): ${listType.repeatedType} is not supported and data would be silently lost.")
        }
    }
...
fun FunSpec.Builder.decodeListType(fieldName: String, listType: ListType) {
    when (listType.repeatedType) {
        ...
        is ReferenceType -> {
            ...
            Logger.error("Nested collection detected in List decode ($fieldName): ${listType.repeatedType} is not supported and data would be silently lost.")
        }
    }
}
